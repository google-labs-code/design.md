...
// ── VALID TYPOGRAPHY PROPERTIES ────────────────────────────────────
export const VALID_TYPOGRAPHY_PROPS = [
  'fontFamily',
  'fontSize',
  'fontWeight',
  'lineHeight',
...
export const VALID_COMPONENT_SUB_TOKENS = [
  'backgroundColor',
  'textColor',
  'typography',
  'rounded',
...
/** Units the spec formally supports. Adding a new unit = one string. */
const STANDARD_UNITS = new Set(['px', 'rem']);
