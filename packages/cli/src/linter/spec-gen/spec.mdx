...
The DESIGN.md file is a textual representation of a design system. The main audience of DESIGN.md is design and coding agents, to help them understand the visual differentiation of a product and avoid producing generic designs. All parts of the file are human readable and understandable, so that the human can create and modify it.
